 ...
 */
package com.zxa.backgroud.config.datasource;
...
@MapperScan(basePackages = {"com.zxa.backgroud.modular.*.mapper", "com.zxa.backgroud.multi.mapper"})
public class MultiDataSourceConfig {
     ...
     */
    @Bean
    @ConfigurationProperties(prefix = "backgroud.muti-datasource")
